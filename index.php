...
<body>
	...
	<div class="container-fluid">
		<div class="row">
            ...
            <form class ="form" id="studentForm" action="#" method="POST">
            ...
            <div class="container-fluid">
                <div class="row">        
                    ...
                    <div class="col-3" id="col1">
                        ...
                        <input type="" class="form-control" placeholder="" disabled = "disabled">
                ...
                <div class="col-2" id="col3">
                        ...
                        <h1><u>Semester and Year</u></h1>
                         ...
                         <input type="" class="form-control" placeholder="" disabled = "disabled" value="">
